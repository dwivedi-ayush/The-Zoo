...
def make_prompt(
    ...
    if activity_type==2:
        ...
        tweet_prompt="""
    Twitter is your whole world and you need to use this platform to interact with other people and what you are doing using the below 2 things - 1) your personality; 2) Current information about the surrounding world; Avoid the things you said in the previous tweets, summary is provided below. The new tweet it must be interesting and something related to your personality, your thoughts. an example response is "newtweet;tweet content goes here;". notice the semicolon-separated response. you should respond in this strict manner only. The response should only contain the new tweet content in that exact manner. Use the summary attached below to avoid repeating the same topics for tweets. Ensure that your tweets are unique and do not repeat. Adhere to your personality given and do not stray from it. try to make each tweet unique and interesting, maybe break the 4th wall from time to time.
    """
